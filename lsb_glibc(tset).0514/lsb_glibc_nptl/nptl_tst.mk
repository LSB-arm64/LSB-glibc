...
$(addprefix $(objpfx),   $(filter-out $(tests-static) $(xtests-static) $(tests-reverse)     $(tests-nolibpthread),     $(tests) $(xtests) $(test-srcs))): $(objpfx)libpthread.so 				       $(objpfx)libpthread_nonshared.a
$(objpfx)tst-unload: $(libdl)
$(addprefix $(objpfx), $(tests-reverse)):   $(objpfx)../libc.so $(objpfx)libpthread.so   $(objpfx)libpthread_nonshared.a
...
tests: $(test-modules)
tests-static += tst-locale1 tst-locale2 tst-stackguard1-static 		tst-cancel21-static tst-cancel24-static tst-cond8-static 		tst-mutex8-static tst-mutexpi8-static tst-sem11-static 		tst-sem12-static
tests += tst-stackguard1-static tst-cancel21-static tst-cancel24-static 	 tst-cond8-static tst-mutex8-static tst-mutexpi8-static 	 tst-sem11-static tst-sem12-static

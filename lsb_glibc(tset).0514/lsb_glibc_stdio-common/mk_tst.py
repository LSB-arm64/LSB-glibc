...
def mk_tst(makefile):
    ...
    # 首先打开makefile源文件
    with open("stdio-common_tst.mk","w") as result:
        with open(makefile,"r") as makefile:
            ...
            while line:
                ...
                # 检查这一行是否需要提取
                if re1.search(line) or re2.match(line) or re3.match(line) or re4.match(line) or re5.match(line) or re6.match(line):
                    result.write(line)

                line=makefile.readline()

if __name__=="__main__":
    mk_tst("stdio-common_mk_src.mk")
$(objpfx)tst-malloc-backtrace: $(common-objpfx)nptl/libpthread.so 			       $(common-objpfx)nptl/libpthread_nonshared.a
$(objpfx)tst-malloc-thread-exit: $(common-objpfx)nptl/libpthread.so 			       $(common-objpfx)nptl/libpthread_nonshared.a
$(objpfx)tst-malloc-thread-fail: $(common-objpfx)nptl/libpthread.so 			       $(common-objpfx)nptl/libpthread_nonshared.a

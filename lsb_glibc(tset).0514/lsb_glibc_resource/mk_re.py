...
def mk_re(makefile):
    ...
    re4=re.compile(r"modules")
    #re4=re.compile(r": ")

    with open("resource_tst.mk","a") as result:
        with open(makefile,"r") as makefile:
            ...
            while line:
                ...
                # 检查这一行是否需要提取
                if re1.match(line) or re2.match(line) or re3.search(line) or re4.match(line):
                    result.write(line)

                line=makefile.readline()

if __name__=="__main__":
    mk_re("resource_mk_src.mk")
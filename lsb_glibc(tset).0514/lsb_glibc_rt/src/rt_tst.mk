...
$(addprefix $(objpfx),$(tests)): /usr/lib/x86_64-linux-gnu/librt.so $(shared-thread-library)
$(addprefix $(objpfx),$(tests)): /usr/lib/x86_64-linux-gnu/librt.a $(static-thread-library)
